...
public class MyListTherapyData {
    ...
    public MyListTherapyData(int imgPsikolog, String nama, String pekerjaan, int lama_kerja, String no_telp, String instagram, int imgLike, int imgDislike, int jumlahLike, int jumlahUnlike) {
